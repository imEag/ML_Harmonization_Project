...
names = ['G1']
space = 'ic'
path_o = r"C:\Users\veroh\OneDrive - Universidad de Antioquia\Articulo análisis longitudinal\Resultados_Armonizacion_Paper_V2\dataframes"
...
path = r"C:\Users\veroh\OneDrive - Universidad de Antioquia\Articulo análisis longitudinal\Eli"
path_save = r"C:\Users\veroh\OneDrive - Universidad de Antioquia\Articulo análisis longitudinal\Eli\Resultados"
ratios = [79, 31, 15]
...
for neuro in neuros:
    for name in names:
        for ratio in ratios:
            ...
            file_path_o = os.path.join(path_o, neuro, f'integration{str_ratio}',space,name,f'Data_integration_ic_{neuro}_{name}.feather')
            data = pd.read_feather(file_path)
            data_o = pd.read_feather(file_path_o)
